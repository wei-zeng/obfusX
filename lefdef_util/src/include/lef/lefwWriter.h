 ...
 * must follow. The type can be either CUT for Cut Layer, MASTERSLICE or
...
/*
 * The following APIs are for lefwrite 5.7 Layer, Spacing with type CUT Due
 * to adding new constructs, it is impossible to use the previous APIs. The
 * following APIs are obsoleted in 5.7: lefwLayer lefwLayerStack
 * lefwLayerSpacingAdjacent lefwLayerSpacingCenterToCenter
 */

/*
 * This routine must be called after lefwStartLayer. This routine starts the
 * Layer Type Cut Spacing Returns 0 if successful. The routing
 * lefwLayerCutSpacingEnd has to call at the end of each spacing. This is a
 * 5.7 syntax.
 */
EXTERN int 
...
/*
 * This routine must be called after lefwLayerSpacing This routine is
 * optional. Returns 0 if successful. This is a 5.7 syntax.
 */
...
/*
 * This routine must be called after lefwLayerSpacing This routine is
 * optional. Either this routine, lefwLayerCutSpacingAdjacent,
 * lefwLayerCutSpacingParallel or lefwLayerCutSpacingArea is called per
 * Spacing. Returns 0 if successful. This is a 5.7 syntax.
 */
EXTERN int 
...
/*
 * This routine must be called after lefwLayerSpacing This routine is
 * optional. Either this routine, lefwLayerCutSpacingLayer,
 * lefwLayerCutSpacingParallel or lefwLayerCutSpacingArea is called per
 * Spacing. Returns 0 if successful. This is a 5.7 syntax.
 */
EXTERN int 
lefwLayerCutSpacingAdjacent(int viaCuts,  /* either 2, 3, or 4, opt */
double distance,
int stack);  /* optional(0) */
 ...
 * This routine must be called after lefwLayerSpacing This routine is
 * optional. Either this routine, lefwLayerCutSpacingLayer,
 * lefwLayerCutSpacingAdjacent or lefwLayerCutSpacingArea is called per
 * Spacing. Returns 0 if successful. This is a 5.7 syntax.
 */
 ...
 * This routine must be called after lefwLayerSpacing This routine is
 * optional. Either this routine, lefwLayerCutSpacingLayer, *
 * lefwLayerCutSpacingAdjacent or lefwLayerCutSpacingParallel is called per
 * Spacing. Returns 0 if successful. This is a 5.7 syntax.
 */
EXTERN int lefwLayerCutSpacingArea(double cutArea);

/*
 * This routine must be called after lefwLayerSpacing This routine marks the
 * end of a Layer Type CUT Spacing Returns 0 if successful. This is a 5.7
 * syntax.
 */
 ...
 * called only once. This section of routines is optional. This is a 5.7
 ...
 */
EXTERN int 
lefwLayerArraySpacing(int longArray,  /* optional (0) */
...
/*
 * This routine must be called after lefwStartLayer. This routine can be
 * called multiple times. This routine is similar as lefwLayerEnclosure, but
 * allow user to add EXCEPTEXTRACUT option This section of routines is
 * optional. This is a 5.7 syntax. Returns 0 if successful. This routine is
 * called if the layer type is CUT when lefwStartLayer is called.
 */
EXTERN int 
...
/*
 * This routine must be called after lefwStartLayer. This routine can be
 * called multiple times. This routine is to write out minLength inside
 * ENCLOSURE instead of WIDTH as in the routine lefwLayerEnclosure &
 * lefwLayerEnclosureWidth. This section of routines is optional. This is a
 * 5.7 syntax. Returns 0 if successful. This routine is called if the layer
...
/*
 * This routine must be called only once after lefwStartLayerRouting. This
 * routine is similar as lefwLayerRoutingMinimumcut, but allow user to
 * specify value for WITHIN This is a 5.7 syntax. This routine is optional
 * Returns 0 if successful.
 */
EXTERN int 
 ...
 * lefwLayerRoutingSpacingSameNet can be called only once after
 * lefwLayerRoutingSpacing. This routine is optional. Returns 0 if
 * successful.
 */
 ...
 * lefwLayerRoutingSpacingSameNet can be be called once after
 * lefwLayerRoutingSpacing. minWidth & maxWidth are optional. Returns 0 if
 * successful.
 */
EXTERN int 
...
/*
 * Either this routine, lefwLayerRoutingSpacingRange or
 * lefwLayerRoutingSpacingRange can be be called once after
 * lefwLayerRoutingSpacing. This is a 5.7 routine. Returns 0 if successful.
 */
EXTERN int 
lefwLayerRoutingSpacingSameNet(int PGOnly);  /* optional (0) */
...
/*
 * This routine must be called only once after
 * lefwLayerRoutingSpacingEndOfLine This routine is optional This is a 5.7
 * syntax. Returns 0 if successful.
 */
EXTERN int 
 ...
 * This routine must be called only once after lefwStartLayerRouting. This
 * routine is optional and can be called once. This routine is equivalent to
 * lefwLayerRoutingMinstep, except it also takes the option for MaxEdges.
 * This is a 5.7 syntax. Returns 0 if successful.
 */
EXTERN int 
...
/*
 * This routine must be called only after lefwStartLayerRouting. This routine
 * is optional and can be called multiple times. This is a 5.7 syntax.
 * Returns 0 if successful.
 */
 ...
 * This routine must be called only after
 * lefwLayerRoutingStartSpacingtableInfluence. This routine is required after
 * lefwLayerRoutingStartSpacingtableTwoWidths. This routine can be called
 * multiple times. This is a 5.7 syntax. Returns 0 if successful.
 */
EXTERN int 
 ...
 * This routine is optional and can be called only once within a layer after
 * each lefwLayerAntennaModel function. This routine is valid only if the
 * layer type is either ROUTING or CUT. This is a 5.7 routine. Returns 0 if
 * successful.
 */
EXTERN int 
 ...
 * lefwMacroObsDesignRuleWidth, lefwMacroObsVia or lefwMacroExceptPGNet must
 * be called. Spacing is optional for minimum spacing. Returns 0 if
 * successful.
 */
EXTERN int 
...
/*
 * This routine is called after lefwStartMacroObs. Either this routine,
 * lefwMacroObsLayer, lefwMacroObsVia or lefwMacroExceptPGNet must be called.
 * Spacing is optional for minimum spacing. This is a 5.4 syntax. Returns 0
 * if successful.
 */
EXTERN int 
...
/*
 * This routine is called after lefwStartMacroObs. Either this routine,
 * lefwMacroObsLayer, lefwMacroObsVia or lefwMacroObsDesignRuleWidth must be
 * called. Spacing is optional for minimum spacing. This is a 5.4 syntax.
 * Returns 0 if successful.
 */
