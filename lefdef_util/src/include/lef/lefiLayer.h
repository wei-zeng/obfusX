...
/*
 * each slot contains number of spacing of slot
 */

/*
 * accumulate total number of spacing
 */

typedef struct lefiTwoWidths_s {
  int             numWidth_;
  int             numWidthAllocated_;
  double         *width_;
  double         *prl_;
  int            *numWidthSpacing_;
  double         *widthSpacing_;
  int            *atNsp_;
} lefiTwoWidths;

EXTERN lefiTwoWidths *
lefiTwoWidths_Create
  PROTO_PARAMS((  ));

EXTERN void
lefiTwoWidths_Delete
  PROTO_PARAMS(( lefiTwoWidths * this ));
...
EXTERN void
lefiTwoWidths_Destroy
  PROTO_PARAMS(( lefiTwoWidths * this ));

EXTERN void
lefiTwoWidths_addTwoWidths
  PROTO_PARAMS(( lefiTwoWidths * this,
                 double width,
                 double runLength,
                 int numSpacing,
...
EXTERN int
lefiTwoWidths_numWidth
  PROTO_PARAMS(( const lefiTwoWidths * this ));
...
EXTERN int
lefiTwoWidths_hasWidthPRL
  PROTO_PARAMS(( const lefiTwoWidths * this,
                 int iWidth ));

EXTERN double
lefiTwoWidths_widthPRL
  PROTO_PARAMS(( const lefiTwoWidths * this,
                 int iWidth ));

EXTERN int
lefiTwoWidths_numWidthSpacing
  PROTO_PARAMS(( const lefiTwoWidths * this,
                 int iWidth ));

EXTERN double
lefiTwoWidths_widthSpacing
  PROTO_PARAMS(( const lefiTwoWidths * this,
                 int iWidth,
                 int iWidthSpacing ));
...
typedef struct lefiOrthogonal_s {
  int             numAllocated_;
  int             numCutOrtho_;
  double         *cutWithin_;
  double         *ortho_;
...
EXTERN lefiOrthogonal *
lefiOrthogonal_Create
  PROTO_PARAMS((  ));

EXTERN void
lefiOrthogonal_Delete
  PROTO_PARAMS(( lefiOrthogonal * this ));
...
EXTERN void
lefiOrthogonal_Destroy
  PROTO_PARAMS(( lefiOrthogonal * this ));

EXTERN void
lefiOrthogonal_addOrthogonal
  PROTO_PARAMS(( lefiOrthogonal * this,
                 double cutWithin,
                 double ortho ));

EXTERN int
lefiOrthogonal_numOrthogonal
  PROTO_PARAMS(( const lefiOrthogonal * this ));

EXTERN double
lefiOrthogonal_cutWithin
  PROTO_PARAMS(( const lefiOrthogonal * this,
                 int index ));

EXTERN double
lefiOrthogonal_orthoSpacing
  PROTO_PARAMS(( const lefiOrthogonal * this,
                 int index ));
...
/*
 * 5.8 - Some layers can be another types
 */
...
/*
 * SPACINGTABLE ORTHOGONAL FOR LAYER CUT
 */
...
typedef struct lefiLayer_s {
  ...
  int            *hasSpacingCutArea_;
  int            *hasSpacingEndOfLine_;
  int            *hasSpacingParellelEdge_;
  int            *hasSpacingTwoEdges_;
  int            *hasSpacingAdjacentExcept_;
  int            *hasSpacingSamenet_;
  int            *hasSpacingSamenetPGonly_;
  ...
  int            *hasMinimumcutWithin_;
  double         *minimumcutWithin_;
  ...
  int            *minstepMaxEdges_;
  double         *minstepMinAdjLength_;
  double         *minstepMinBetLength_;
  int            *minstepXSameCorners_;
  char           *direction_;
  double          resistance_;
  double          capacitance_;
  double          height_;
...
EXTERN void
lefiLayer_setSpacingLayerStack
  PROTO_PARAMS(( lefiLayer * this ));
...
EXTERN void
lefiLayer_setSpacingAdjacentExcept
  PROTO_PARAMS(( lefiLayer * this ));

EXTERN void
lefiLayer_setSpacingSamenet
  PROTO_PARAMS(( lefiLayer * this ));

EXTERN void
lefiLayer_setSpacingSamenetPGonly
  PROTO_PARAMS(( lefiLayer * this ));

EXTERN void
lefiLayer_setSpacingTableOrtho
  PROTO_PARAMS(( lefiLayer * this ));

EXTERN void
lefiLayer_addSpacingTableOrthoWithin
  PROTO_PARAMS(( lefiLayer * this,
                 double cutWithin,
                 double ortho ));
...
EXTERN void
lefiLayer_setArraySpacingLongArray
  PROTO_PARAMS(( lefiLayer * this ));

EXTERN void
lefiLayer_setArraySpacingWidth
  PROTO_PARAMS(( lefiLayer * this,
                 double viaWidth ));

EXTERN void
lefiLayer_setArraySpacingCut
  PROTO_PARAMS(( lefiLayer * this,
                 double cutSpacing ));

EXTERN void
lefiLayer_addArraySpacingArray
  PROTO_PARAMS(( lefiLayer * this,
                 int aCuts,
                 double aSpacing ));

EXTERN void
lefiLayer_setSpacingNotchLength
  PROTO_PARAMS(( lefiLayer * this,
                 double minNotchLength ));

EXTERN void
lefiLayer_setSpacingEndOfNotchWidth
  PROTO_PARAMS(( lefiLayer * this,
                 double endOfNotchWidth,
...
EXTERN void
lefiLayer_addMinstepMinAdjLength
  PROTO_PARAMS(( lefiLayer * this,
                 double minAdjLength ));

EXTERN void
lefiLayer_addMinstepMinBetLength
  PROTO_PARAMS(( lefiLayer * this,
                 double minBetLength ));
...
EXTERN void
lefiLayer_addEnclosureExceptEC
  PROTO_PARAMS(( lefiLayer * this,
                 double cutWithin ));

EXTERN void
lefiLayer_addEnclosureLength
  PROTO_PARAMS(( lefiLayer * this,
                 double minLength ));

EXTERN void
lefiLayer_addEnclosureExtraCut
  PROTO_PARAMS(( lefiLayer * this ));
...
EXTERN int
lefiLayer_hasSpacingLayerStack
  PROTO_PARAMS(( const lefiLayer * this,
                 int index ));
...
EXTERN int
lefiLayer_hasSpacingAdjacentExcept
  PROTO_PARAMS(( const lefiLayer * this,
                 int index ));

EXTERN int
lefiLayer_hasSpacingSamenet
  PROTO_PARAMS(( const lefiLayer * this,
                 int index ));

EXTERN int
lefiLayer_hasSpacingSamenetPGonly
  PROTO_PARAMS(( const lefiLayer * this,
                 int index ));

EXTERN int
lefiLayer_hasSpacingNotchLength
  PROTO_PARAMS(( const lefiLayer * this,
                 int index ));

EXTERN int
lefiLayer_hasSpacingEndOfNotchWidth
  PROTO_PARAMS(( const lefiLayer * this,
                 int index ));
...
EXTERN double
lefiLayer_spacingNotchLength
  PROTO_PARAMS(( const lefiLayer * this,
                 int index ));

EXTERN double
lefiLayer_spacingEndOfNotchWidth
  PROTO_PARAMS(( const lefiLayer * this,
                 int index ));

EXTERN double
lefiLayer_spacingEndOfNotchSpacing
  PROTO_PARAMS(( const lefiLayer * this,
                 int index ));

EXTERN double
lefiLayer_spacingEndOfNotchLength
  PROTO_PARAMS(( const lefiLayer * this,
                 int index ));
...
EXTERN int
lefiLayer_hasMinimumcutWithin
  PROTO_PARAMS(( const lefiLayer * this,
                 int index ));

EXTERN double
lefiLayer_minimumcutWithin
  PROTO_PARAMS(( const lefiLayer * this,
                 int index ));
...
EXTERN int
lefiLayer_hasMinstepMinAdjLength
  PROTO_PARAMS(( const lefiLayer * this,
                 int index ));

EXTERN double
lefiLayer_minstepMinAdjLength
  PROTO_PARAMS(( const lefiLayer * this,
                 int index ));

EXTERN int
lefiLayer_hasMinstepMinBetLength
  PROTO_PARAMS(( const lefiLayer * this,
                 int index ));

EXTERN double
lefiLayer_minstepMinBetLength
  PROTO_PARAMS(( const lefiLayer * this,
                 int index ));

EXTERN int
lefiLayer_hasMinstepXSameCorners
  PROTO_PARAMS(( const lefiLayer * this,
                 int index ));
...
EXTERN int
lefiLayer_hasEnclosureExceptExtraCut
  PROTO_PARAMS(( const lefiLayer * this,
                 int index ));

EXTERN double
lefiLayer_enclosureExceptExtraCut
  PROTO_PARAMS(( const lefiLayer * this,
                 int index ));

EXTERN int
lefiLayer_hasEnclosureMinLength
  PROTO_PARAMS(( const lefiLayer * this,
                 int index ));

EXTERN double
lefiLayer_enclosureMinLength
  PROTO_PARAMS(( const lefiLayer * this,
                 int index ));
...
EXTERN int
lefiLayer_hasSpacingTableOrtho
  PROTO_PARAMS(( const lefiLayer * this ));

EXTERN lefiOrthogonal *
lefiLayer_orthogonal
  PROTO_PARAMS(( const lefiLayer * this ));
